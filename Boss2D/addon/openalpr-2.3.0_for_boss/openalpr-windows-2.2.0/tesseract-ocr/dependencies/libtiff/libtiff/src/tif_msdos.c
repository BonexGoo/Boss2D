...
#include BOSS_FAKEWIN_V_io_h //original-code:<io.h>		/* for open, close, etc. function prototypes */
#include <stdio.h>
#endif
...
#ifdef __GNUC__
// removed by BOSS: extern	char* malloc();
// removed by BOSS: extern	char* realloc();
#else
