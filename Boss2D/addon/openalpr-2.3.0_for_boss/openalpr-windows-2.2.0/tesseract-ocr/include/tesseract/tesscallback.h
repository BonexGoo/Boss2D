...
// remove for BOSS:template <class T> struct remove_reference;
// remove for BOSS:template<typename T> struct remove_reference { typedef T type; };
// remove for BOSS:template<typename T> struct remove_reference<T&> { typedef T type; };
