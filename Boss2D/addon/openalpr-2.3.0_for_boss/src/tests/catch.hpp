...
namespace Catch{
    ...
    extern "C" BOSS_FAKEWIN_DECLSPEC_DLLIMPORT void BOSS_FAKEWIN_STDCALL DebugBreak();
...
#elif defined(_MSC_VER)
    extern "C" BOSS_FAKEWIN_DECLSPEC_DLLIMPORT int BOSS_FAKEWIN_STDCALL IsDebuggerPresent();
    namespace Catch {
        bool isDebuggerActive() {
...
#ifdef CATCH_PLATFORM_WINDOWS
    extern "C" BOSS_FAKEWIN_DECLSPEC_DLLIMPORT void BOSS_FAKEWIN_STDCALL OutputDebugStringA( const char* );
    namespace Catch {
        void writeToDebugConsole( std::string const& text ) {
