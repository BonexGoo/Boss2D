...
// removed by BOSS: #define snprintf _snprintf_s
// removed by BOSS: #define sprintf sprintf_s
#define stricmp _stricmp
#define strtof strtod /* not really correct but best we can do */
#define strtoll _strtoi64
#define strtoull _strtoui64
// removed by BOSS: #define vsnprintf vsnprintf_s
...
#include BOSS_OPENALPR_U_re2__util__logging_h //original-code:"re2/util/logging.h"
#include BOSS_OPENALPR_U_re2__util__mutex_h //original-code:"re2/util/mutex.h"
#include BOSS_OPENALPR_U_re2__util__utf_h //original-code:"re2/util/utf.h"
