...
#   include BOSS_FAKEWIN_V_intrin_h //original-code:<intrin.h>
...
// removed by BOSS: static __inline int CRYPTO_UP_REF(volatile int *val, int *ret, void *lock)
static __inline int CRYPTO_UP_REF(volatile long *val, long *ret, void *lock) // added by BOSS
{
    *ret = _InterlockedExchangeAdd(val, 1) + 1;
    return 1;
}

// removed by BOSS: static __inline int CRYPTO_DOWN_REF(volatile int *val, int *ret, void *lock)
static __inline int CRYPTO_DOWN_REF(volatile long *val, long *ret, void *lock) // added by BOSS
{
    *ret = _InterlockedExchangeAdd(val, -1) - 1;
    return 1;
}
