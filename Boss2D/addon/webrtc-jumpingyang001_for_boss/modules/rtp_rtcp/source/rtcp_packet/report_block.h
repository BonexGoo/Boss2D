...
class ReportBlock_rtcp_BOSS { // modified by BOSS, original-code: ReportBlock, replace-code: ReportBlock_rtcp_BOSS
 public:
  static const size_t kLength = 24;

  ReportBlock_rtcp_BOSS(); // modified by BOSS, original-code: ReportBlock, replace-code: ReportBlock_rtcp_BOSS
  ~ReportBlock_rtcp_BOSS() {} // modified by BOSS, original-code: ReportBlock, replace-code: ReportBlock_rtcp_BOSS
