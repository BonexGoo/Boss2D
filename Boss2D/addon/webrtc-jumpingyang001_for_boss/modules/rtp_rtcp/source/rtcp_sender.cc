...
#include BOSS_WEBRTC_U_modules__rtp_rtcp__source__rtp_rtcp_impl_h //original-code:"modules/rtp_rtcp/source/rtp_rtcp_impl.h"
...
std::vector<rtcp::ReportBlock_rtcp_BOSS> RTCPSender::CreateReportBlocks( // modified by BOSS, original-code: ReportBlock, replace-code: ReportBlock_rtcp_BOSS
    const FeedbackState& feedback_state) {
