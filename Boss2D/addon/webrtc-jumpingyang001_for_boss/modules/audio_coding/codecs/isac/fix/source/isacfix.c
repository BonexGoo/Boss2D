...
#include BOSS_WEBRTC_U_modules__audio_coding__codecs__isac__fix__include__isacfix_h //original-code:"modules/audio_coding/codecs/isac/fix/include/isacfix.h"
...
#include BOSS_WEBRTC_U_modules__audio_coding__codecs__isac__fix__source__filterbank_internal_h //original-code:"modules/audio_coding/codecs/isac/fix/source/filterbank_internal.h"
...
int16_t WebRtcIsacfix_Assign(ISACFIX_MainStruct **inst, void *ISACFIX_inst_Addr) {
  if (ISACFIX_inst_Addr!=NULL) {
    ISACFIX_SubStruct* self = (ISACFIX_SubStruct*) ISACFIX_inst_Addr; // modified by BOSS, added-code: (ISACFIX_SubStruct*)
...
int16_t WebRtcIsacfix_Create(ISACFIX_MainStruct **ISAC_main_inst)
{
  ...
  tempo = (ISACFIX_SubStruct*) malloc(1 * sizeof(ISACFIX_SubStruct)); // modified by BOSS, added-code: (ISACFIX_SubStruct*)
...
int16_t WebRtcIsacfix_CreateInternal(ISACFIX_MainStruct *ISAC_main_inst)
{
  ...
  ISAC_inst->ISACenc_obj.SaveEnc_ptr = (IsacSaveEncoderData*) malloc(1 * sizeof(IsacSaveEncoderData)); // modified by BOSS, added-code: (IsacSaveEncoderData*)
