...
#include BOSS_WEBRTC_U_modules__audio_processing__ns__noise_suppression_x_h //original-code:"modules/audio_processing/ns/noise_suppression_x.h"

#include <stdlib.h>

#include BOSS_WEBRTC_U_common_audio__signal_processing__include__real_fft_h //original-code:"common_audio/signal_processing/include/real_fft.h"
#include BOSS_WEBRTC_U_modules__audio_processing__ns__nsx_core_h //original-code:"modules/audio_processing/ns/nsx_core.h"
#include BOSS_WEBRTC_U_modules__audio_processing__ns__nsx_defines_h //original-code:"modules/audio_processing/ns/nsx_defines.h"

NsxHandle* WebRtcNsx_Create() {
  NoiseSuppressionFixedC* self = (NoiseSuppressionFixedC*) malloc(sizeof(NoiseSuppressionFixedC)); // modified by BOSS, added-code: (NoiseSuppressionFixedC*)
  WebRtcSpl_Init();
  self->real_fft = NULL;
  self->initFlag = 0;
