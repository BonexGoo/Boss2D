...
#include BOSS_WEBRTC_U_modules__audio_processing__agc__legacy__analog_agc_h //original-code:"modules/audio_processing/agc/legacy/analog_agc.h"
...
void* WebRtcAgc_Create() {
  LegacyAgc* stt = (LegacyAgc*) malloc(sizeof(LegacyAgc)); // modified by BOSS, added-code: (LegacyAgc*)
