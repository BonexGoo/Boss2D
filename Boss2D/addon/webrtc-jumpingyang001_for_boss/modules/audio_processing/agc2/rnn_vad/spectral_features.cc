...
#include BOSS_WEBRTC_U_modules__audio_processing__agc2__rnn_vad__spectral_features_h //original-code:"modules/audio_processing/agc2/rnn_vad/spectral_features.h"
