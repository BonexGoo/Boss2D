...
#include BOSS_WEBRTC_U_pc__statscollector_h //original-code:"pc/statscollector.h"
...
void ExtractStats(const cricket::VoiceReceiverInfo& info, StatsReport* report) {
  ...
  const FloatForAdd floats[] = {
      ...
      {StatsReport::kStatsValueNameTotalAudioEnergy, (float) info.total_output_energy}, // added by BOSS: (float)
      {StatsReport::kStatsValueNameTotalSamplesDuration,
       (float) info.total_output_duration}}; // added by BOSS: (float)
...
void ExtractStats(const cricket::VoiceSenderInfo& info, StatsReport* report) {
  ...
  const FloatForAdd floats[] = {
      {StatsReport::kStatsValueNameTotalAudioEnergy, (float) info.total_input_energy}, // added by BOSS: (float)
      {StatsReport::kStatsValueNameTotalSamplesDuration,
       (float) info.total_input_duration}}; // added by BOSS: (float)
...
void ExtractStats(const cricket::VideoReceiverInfo& info, StatsReport* report) {
  ...
  const IntForAdd ints[] = {
      ...
      {StatsReport::kStatsValueNameFramesDecoded, (int) info.frames_decoded}, // added by BOSS: (int)
  };
...
void ExtractStats(const cricket::VideoSenderInfo& info, StatsReport* report) {
  ...
  const IntForAdd ints[] = {
      ...
      {StatsReport::kStatsValueNameFramesEncoded, (int) info.frames_encoded}, // added by BOSS: (int)
      {StatsReport::kStatsValueNameHugeFramesSent, (int) info.huge_frames_sent}, // added by BOSS: (int)
  };
...
StatsReport* StatsCollector::AddConnectionInfoReport(
  ...
  const Int64ForAdd int64s[] = {
      {StatsReport::kStatsValueNameBytesReceived, (int64_t) info.recv_total_bytes}, // added by BOSS: (int64_t)
      {StatsReport::kStatsValueNameBytesSent, (int64_t) info.sent_total_bytes}, // added by BOSS: (int64_t)
      {StatsReport::kStatsValueNamePacketsSent, (int64_t) info.sent_total_packets}, // added by BOSS: (int64_t)
      {StatsReport::kStatsValueNameRtt, (int64_t) info.rtt}, // added by BOSS: (int64_t)
      {StatsReport::kStatsValueNameSendPacketsDiscarded,
       (int64_t) info.sent_discarded_packets}, // added by BOSS: (int64_t)
      {StatsReport::kStatsValueNameSentPingRequestsTotal,
       (int64_t) info.sent_ping_requests_total}, // added by BOSS: (int64_t)
      {StatsReport::kStatsValueNameSentPingRequestsBeforeFirstResponse,
       (int64_t) info.sent_ping_requests_before_first_response}, // added by BOSS: (int64_t)
      {StatsReport::kStatsValueNameSentPingResponses, (int64_t) info.sent_ping_responses}, // added by BOSS: (int64_t)
      {StatsReport::kStatsValueNameRecvPingRequests, (int64_t) info.recv_ping_requests}, // added by BOSS: (int64_t)
      {StatsReport::kStatsValueNameRecvPingResponses, (int64_t) info.recv_ping_responses}, // added by BOSS: (int64_t)
  };
