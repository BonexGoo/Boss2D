...
// removed by BOSS:struct addrinfo {
// removed by BOSS:  struct sockaddr* ai_addr;
// removed by BOSS:  int ai_addrlen;
// removed by BOSS:  int ai_family;
// removed by BOSS:  int ai_socktype;
// removed by BOSS:  int ai_protocol;
// removed by BOSS:};
#else
#include <arpa/inet.h>
#include <netdb.h>
