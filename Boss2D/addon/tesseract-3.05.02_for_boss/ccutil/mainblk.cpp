...
#include          BOSS_TESSERACT_U_fileerr_h //original-code:"fileerr.h"
#ifdef __UNIX__
#include          <unistd.h>
#include          <signal.h>
#else
...
#if defined(_WIN32)
  } else if (datadir == NULL || BOSS_TESSERACT_access(datadir.string(), 0) != 0) { // modified by BOSS, original-code: access(datadir.string(), 0) != 0) {
