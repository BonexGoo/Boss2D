...
#if defined(_WIN32)
#ifdef _MSC_VER
#include BOSS_TESSERACT_U_vcsversion_h //original-code:"vcsversion.h"
#include BOSS_TESSERACT_U_mathfix_h //original-code:"mathfix.h"
#elif MINGW
...
#include BOSS_TESSERACT_U_baseapi_h //original-code:"baseapi.h"
#include BOSS_TESSERACT_U_blobclass_h //original-code:"blobclass.h"
#include BOSS_TESSERACT_U_resultiterator_h //original-code:"resultiterator.h"
#include BOSS_TESSERACT_U_mutableiterator_h //original-code:"mutableiterator.h"
#include BOSS_TESSERACT_U_thresholder_h //original-code:"thresholder.h"
...
#include BOSS_TESSERACT_U_paragraphs_h //original-code:"paragraphs.h"
#include BOSS_TESSERACT_U_tessvars_h //original-code:"tessvars.h"
#include BOSS_TESSERACT_U_control_h //original-code:"control.h"
#include BOSS_TESSERACT_U_dict_h //original-code:"dict.h"
#include BOSS_TESSERACT_U_pgedit_h //original-code:"pgedit.h"
#include BOSS_TESSERACT_U_paramsd_h //original-code:"paramsd.h"
#include BOSS_TESSERACT_U_output_h //original-code:"output.h"
#include BOSS_TESSERACT_U_globaloc_h //original-code:"globaloc.h"
#include BOSS_TESSERACT_U_globals_h //original-code:"globals.h"
#include BOSS_TESSERACT_U_edgblob_h //original-code:"edgblob.h"
#include BOSS_TESSERACT_U_equationdetect_h //original-code:"equationdetect.h"
#include BOSS_TESSERACT_U_tessbox_h //original-code:"tessbox.h"
#include BOSS_TESSERACT_U_makerow_h //original-code:"makerow.h"
#include BOSS_TESSERACT_U_otsuthr_h //original-code:"otsuthr.h"
#include BOSS_TESSERACT_U_osdetect_h //original-code:"osdetect.h"
#include BOSS_TESSERACT_U_params_h //original-code:"params.h"
#include "renderer.h"
#include BOSS_TESSERACT_U_strngs_h //original-code:"strngs.h"
#include BOSS_TESSERACT_U_openclwrapper_h //original-code:"openclwrapper.h"
...
static void AddIdTohOCR(STRING* hocr_str, const std::string base, int num1, int num2) {
  ...
  char id_buffer[2048]; // modified by BOSS (char id_buffer[bufsize])
  if (num2 >= 0) {
