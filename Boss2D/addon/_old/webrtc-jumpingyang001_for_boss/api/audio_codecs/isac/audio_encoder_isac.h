...
#include BOSS_WEBRTC_U_api__audio_codecs__isac__audio_encoder_isac_fix_h //original-code:"api/audio_codecs/isac/audio_encoder_isac_fix.h"  // nogncheck
#elif WEBRTC_USE_BUILTIN_ISAC_FLOAT && !WEBRTC_USE_BUILTIN_ISAC_FIX
#include BOSS_WEBRTC_U_api__audio_codecs__isac__audio_encoder_isac_float_h //original-code:"api/audio_codecs/isac/audio_encoder_isac_float.h"  // nogncheck
#else
