...
class ReceiveStatisticsImpl : public ReceiveStatistics,
 ...
 public:
  ...
  std::vector<rtcp::ReportBlock_rtcp_BOSS> RtcpReportBlocks(size_t max_blocks) override; // modified by BOSS, original-code: ReportBlock, replace-code: ReportBlock_rtcp_BOSS
