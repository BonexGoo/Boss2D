...
#include BOSS_WEBRTC_U_modules__rtp_rtcp__source__time_util_h //original-code:"modules/rtp_rtcp/source/time_util.h"
#include BOSS_WEBRTC_U_modules__rtp_rtcp__source__tmmbr_help_h //original-code:"modules/rtp_rtcp/source/tmmbr_help.h"
...
using rtcp::ReportBlock_rtcp_BOSS; // modified by BOSS, original-code: ReportBlock, replace-code: ReportBlock_rtcp_BOSS
...
void RTCPReceiver::HandleSenderReport(const CommonHeader& rtcp_block,
  ...
  for (const rtcp::ReportBlock_rtcp_BOSS report_block : sender_report.report_blocks()) // modified by BOSS, original-code: ReportBlock, replace-code: ReportBlock_rtcp_BOSS
...
void RTCPReceiver::HandleReceiverReport(const CommonHeader& rtcp_block,
  ...
  for (const ReportBlock_rtcp_BOSS& report_block : receiver_report.report_blocks()) // modified by BOSS, original-code: ReportBlock, replace-code: ReportBlock_rtcp_BOSS
    HandleReportBlock(report_block, packet_information, remote_ssrc);
}

void RTCPReceiver::HandleReportBlock(const ReportBlock_rtcp_BOSS& report_block, // modified by BOSS, original-code: ReportBlock, replace-code: ReportBlock_rtcp_BOSS
                                     PacketInformation* packet_information,
