...
#include BOSS_WEBRTC_U_modules__audio_coding__codecs__isac__main__include__isac_h //original-code:"modules/audio_coding/codecs/isac/main/include/isac.h"
...
#include BOSS_WEBRTC_U_modules__audio_coding__codecs__isac__main__source__crc_h //original-code:"modules/audio_coding/codecs/isac/main/source/crc.h"
...
void WebRtcIsac_SetEncSampRateInDecoder(ISACStruct* inst,
  ...
  instISAC->encoderSamplingRateKHz = (enum IsacSamplingRate) (sample_rate_hz / 1000); // modified by BOSS, added-code: (enum IsacSamplingRate)
}
