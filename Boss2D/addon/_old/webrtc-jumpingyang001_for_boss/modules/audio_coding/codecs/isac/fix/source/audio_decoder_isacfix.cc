...
#include BOSS_WEBRTC_U_modules__audio_coding__codecs__isac__audio_decoder_isac_t_impl_h //original-code:"modules/audio_coding/codecs/isac/audio_decoder_isac_t_impl.h"
