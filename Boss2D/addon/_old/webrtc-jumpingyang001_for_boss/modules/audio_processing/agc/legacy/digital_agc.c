...
#include BOSS_WEBRTC_U_modules__audio_processing__agc__legacy__digital_agc_h //original-code:"modules/audio_processing/agc/legacy/digital_agc.h"
...
#include BOSS_WEBRTC_U_modules__audio_processing__agc__legacy__gain_control_h //original-code:"modules/audio_processing/agc/legacy/gain_control.h"
...
int32_t WebRtcAgc_ProcessDigital(DigitalAgc* stt,
                                 ...
                                 size_t num_bands,
                                 int16_t* const* out,
                                 uint32_t fs, // modified by BOSS, original-code: FS, replace-code: fs
  ...
  if (fs == 8000) { // modified by BOSS, original-code: FS, replace-code: fs
    L = 8;
    L2 = 3;
  } else if (fs == 16000 || fs == 32000 || fs == 48000) { // modified by BOSS, original-code: FS, replace-code: fs
    L = 16;
    L2 = 4;
  } else {
    return -1;
