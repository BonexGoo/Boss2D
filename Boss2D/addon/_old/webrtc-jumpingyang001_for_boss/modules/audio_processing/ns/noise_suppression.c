...
#include BOSS_WEBRTC_U_modules__audio_processing__ns__defines_h //original-code:"modules/audio_processing/ns/defines.h"
#include BOSS_WEBRTC_U_modules__audio_processing__ns__ns_core_h //original-code:"modules/audio_processing/ns/ns_core.h"

NsHandle* WebRtcNs_Create() {
  NoiseSuppressionC* self = (NoiseSuppressionC*) malloc(sizeof(NoiseSuppressionC)); // modified by BOSS, added-code: (NoiseSuppressionC*)
  self->initFlag = 0;
