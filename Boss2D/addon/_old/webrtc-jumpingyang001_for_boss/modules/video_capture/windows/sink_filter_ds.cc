...
#include BOSS_WEBRTC_U_modules__video_capture__windows__sink_filter_ds_h //original-code:"modules/video_capture/windows/sink_filter_ds.h"
...
CaptureInputPin::CheckMediaType(IN const CMediaType* pMediaType) {
  ...
  if (*formatType == FORMAT_VideoInfo) {
    ...
    // removed by BOSS: if (*SubType == MEDIASUBTYPE_HDYC) {
    // removed by BOSS:   _resultingCapability.videoType = VideoType::kUYVY;
    // removed by BOSS:   return S_OK;  // This format is acceptable.
    // removed by BOSS: }
