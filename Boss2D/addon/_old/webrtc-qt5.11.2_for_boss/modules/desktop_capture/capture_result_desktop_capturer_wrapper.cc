...
#include BOSS_WEBRTC_U_modules__desktop_capture__capture_result_desktop_capturer_wrapper_h //original-code:"modules/desktop_capture/capture_result_desktop_capturer_wrapper.h"
