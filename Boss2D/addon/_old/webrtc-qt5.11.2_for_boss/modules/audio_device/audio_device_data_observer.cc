...
#include BOSS_WEBRTC_U_modules__audio_device__include__audio_device_data_observer_h //original-code:"modules/audio_device/include/audio_device_data_observer.h"
