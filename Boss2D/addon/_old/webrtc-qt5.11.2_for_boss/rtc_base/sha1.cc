 ...
 * 1. Added #include BOSS_FAKEWIN_V_process_h //original-code:<process.h> for exit() prototype
 ...
 * Still 100% public domain
 *
 * 1- Removed #include BOSS_FAKEWIN_V_process_h //original-code:<process.h> and used return() instead of exit()
