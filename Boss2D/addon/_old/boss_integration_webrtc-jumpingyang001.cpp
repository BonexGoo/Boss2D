...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/asyncinvoker.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/asyncpacketsocket.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/asyncresolverinterface.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/asyncsocket.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/asynctcpsocket.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/asyncudpsocket.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/bitbuffer.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/bitrateallocationstrategy.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/bufferqueue.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/bytebuffer.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/copyonwritebuffer.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/criticalsection.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/cryptstring.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/fakeclock.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/fakesslidentity.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/file.cc>
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/file_posix.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/file_win.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/filerotatingstream.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/fileutils.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/firewallsocketserver.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/flags.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/helpers.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/httpbase.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/httpcommon.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/httpserver.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/ifaddrs-android.cc>
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/ifaddrs_converter.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/ipaddress.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/json.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/logsinks.cc>
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/macifaddrs_converter.cc>
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/macutils.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/memory_usage.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/messagedigest.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/messagehandler.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/messagequeue.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/natserver.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/natsocketfactory.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/nattypes.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/nethelper.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/nethelpers.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/network.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/networkmonitor.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/noop.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/nullsocketserver.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/openssladapter.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/opensslcertificate.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/openssldigest.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/opensslidentity.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/opensslsessioncache.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/opensslstreamadapter.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/opensslutility.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/optionsfile.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/pathutils.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/physicalsocketserver.cc>
#undef PACKET_MAXIMUMS
#undef IP_HEADER_SIZE
#undef ICMP_HEADER_SIZE
#undef ICMP_PING_TIMEOUT_MILLIS

#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/platform_file.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/proxyinfo.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/proxyserver.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/ratetracker.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/rtccertificate.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/rtccertificategenerator.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/sequenced_task_checker_impl.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/signalthread.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/socket.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/socketadapters.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/socketaddress.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/socketaddresspair.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/socketstream.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/ssladapter.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/sslcertificate.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/sslfingerprint.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/sslidentity.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/sslstreamadapter.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/stringencode.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/stringutils.cc>
...
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/task_queue_posix.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/task_queue_win.cc>
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/testclient.cc>
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/testechoserver.cc>
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/testutils.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/thread.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/thread_checker_impl.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/timestampaligner.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/timeutils.cc>
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/unixfilesystem.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/virtualsocketserver.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/win32filesystem.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/win32socketinit.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/win32socketserver.cc>
#undef PACKET_MAXIMUMS
#undef IP_HEADER_SIZE
#undef ICMP_HEADER_SIZE
#undef ICMP_PING_TIMEOUT_MILLIS

#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/win32window.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/experiments/congestion_controller_experiment.cc>
...
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/synchronization/rw_lock_posix.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/synchronization/rw_lock_win.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/rtc_base/synchronization/rw_lock_wrapper.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/api/datachannelinterface.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/api/jsep.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/api/jsepicecandidate.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/api/mediaconstraintsinterface.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/api/mediastreaminterface.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/api/mediatypes.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/api/peerconnectioninterface.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/api/proxy.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/api/rtcerror.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/api/rtp_headers.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/api/rtpparameters.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/api/rtpreceiverinterface.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/api/rtptransceiverinterface.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/api/statstypes.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/api/video/video_stream_encoder_create.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/audio/channel.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/audio/channel_proxy.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/audio/time_interval.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/audio/transport_feedback_packet_loss_tracker.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/call/callfactory.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/call/packet_receiver.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/call/receive_time_calculator.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/call/rtcp_demuxer.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/call/rtp_rtcp_demuxer_helper.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/common_audio/audio_ring_buffer.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/common_audio/audio_util.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/common_audio/blocker.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/common_audio/lapped_transform.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/common_audio/sparse_fir_filter.cc>
...
extern "C"
{
    #include <addon/webrtc-jumpingyang001-20210616_for_boss/common_audio/third_party/fft4g/fft4g.c>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/common_video/i420_buffer_pool.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/common_video/incoming_video_stream.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/common_video/video_frame.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/audiotrack.cc>
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/bundlefilter.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/channel.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/channelmanager.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/createpeerconnectionfactory.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/datachannel.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/dtlssrtptransport.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/dtmfsender.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/externalhmac.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/iceserverparsing.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/jsepicecandidate.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/jsepsessiondescription.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/jseptransport.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/jseptransportcontroller.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/localaudiosource.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/mediasession.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/mediastream.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/mediastreamobserver.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/peerconnection.cc>
#undef MSG_CREATE_SESSIONDESCRIPTION_FAILED
#undef CreateSessionDescriptionMsg

#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/peerconnectionfactory.cc>
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/peerconnectionwrapper.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/remoteaudiosource.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/rtcpmuxfilter.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/rtcstatscollector.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/rtcstatstraversal.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/rtpmediautils.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/rtpparametersconversion.cc>

#define GenerateUniqueId GenerateUniqueId_rtpreceiver_BOSS
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/rtpreceiver.cc>
#undef GenerateUniqueId

#define GenerateUniqueId GenerateUniqueId_rtpsender_BOSS
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/rtpsender.cc>
#undef GenerateUniqueId

#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/rtptransceiver.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/rtptransport.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/sctputils.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/sdputils.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/sessiondescription.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/srtpfilter.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/srtpsession.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/srtptransport.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/statscollector.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/trackmediainfomap.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/transportstats.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/videocapturertracksource.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/videotrack.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/videotracksource.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/webrtcsdp.cc>
#undef kPreferenceUnknown
#undef kPreferenceHost
#undef kPreferenceReflexive
#undef kPreferenceRelayed
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/pc/webrtcsessiondescriptionfactory.cc>
#undef MSG_CREATE_SESSIONDESCRIPTION_FAILED
#undef CreateSessionDescriptionMsg

#include <addon/webrtc-jumpingyang001-20210616_for_boss/stats/rtcstats.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/stats/rtcstats_objects.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/stats/rtcstatsreport.cc>

#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/base/asyncstuntcpsocket.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/base/basicpacketsocketfactory.cc>

#define kMinRtpPacketLen kMinRtpPacketLen_dtlstransport_BOSS
#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/base/dtlstransport.cc>
#undef kMinRtpPacketLen

#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/base/dtlstransportinternal.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/base/icetransportinternal.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/base/p2pconstants.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/base/p2ptransportchannel.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/base/packetlossestimator.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/base/packetsocketfactory.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/base/packettransportinternal.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/base/port.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/base/portallocator.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/base/portinterface.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/base/pseudotcp.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/base/regatheringcontroller.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/base/relayport.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/base/relayserver.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/base/stun.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/base/stunport.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/base/stunrequest.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/base/stunserver.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/base/tcpport.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/base/teststunserver.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/base/transportdescription.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/base/transportdescriptionfactory.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/base/turnport.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/base/turnserver.cc>
#undef TURN_CHANNEL_HEADER_SIZE
#undef IsTurnChannelData

#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/base/udptransport.cc>

#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/client/basicportallocator.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/p2p/client/turnportfactory.cc>

#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/base/adaptedvideotracksource.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/base/codec.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/base/fakeframesource.cc>
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/base/fakertp.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/base/fakevideocapturer.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/base/fakevideorenderer.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/base/h264_profile_level_id.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/base/mediachannel.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/base/mediaconstants.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/base/mediaengine.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/base/rtpdataengine.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/base/rtputils.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/base/streamparams.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/base/turnutils.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/base/videoadapter.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/base/videobroadcaster.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/base/videocapturer.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/base/videocommon.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/base/videosourcebase.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/base/vp9_profile.cc>

#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/engine/adm_helpers.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/engine/apm_helpers.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/engine/constants.cc>
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/engine/convert_legacy_video_factory.cc>

#define IsFormatSupported IsFormatSupported_internaldecoderfactory_BOSS
#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/engine/internaldecoderfactory.cc>
#undef IsFormatSupported

#define IsFormatSupported IsFormatSupported_internalencoderfactory_BOSS
#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/engine/internalencoderfactory.cc>
#undef IsFormatSupported

//#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/engine/multiplexcodecfactory.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/engine/payload_type_mapper.cc>
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/engine/scopedvideodecoder.cc>
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/engine/scopedvideoencoder.cc>
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/engine/simulcast.cc>
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/engine/simulcast_encoder_adapter.cc> libyuv필요!
#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/engine/vp8_encoder_simulcast_proxy.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/engine/webrtcmediaengine.cc>
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/engine/webrtcvideocapturer.cc> libyuv필요!
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/engine/webrtcvideocapturerfactory.cc> libyuv필요!
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/engine/webrtcvideodecoderfactory.cc>
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/engine/webrtcvideoencoderfactory.cc>
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/engine/webrtcvideoengine.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/engine/webrtcvoiceengine.cc>

#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/sctp/noop.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/media/sctp/sctptransport.cc>

#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_coding/acm2/acm_codec_database.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_coding/acm2/codec_manager.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_coding/acm2/rent_a_codec.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_coding/audio_network_adaptor/fec_controller_rplr_based.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_coding/codecs/audio_format_conversion.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_coding/codecs/isac/locked_bandwidth_info.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_coding/neteq/delay_peak_detector.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_coding/neteq/neteq.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_coding/neteq/neteq_decoder_enum.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_coding/neteq/rtcp.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_coding/neteq/tick_timer.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/echo_cancellation_impl.cc>
#undef MapError
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/gain_control_for_experimental_agc.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/level_estimator_impl.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/low_cut_filter.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/noise_suppression_impl.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/voice_detection_impl.cc>

#define MulRe MulRe_aec_core_BOSS
#define MulIm MulIm_aec_core_BOSS
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/aec/aec_core.cc>
#undef MulRe
#undef MulIm

//#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/aec/aec_core_mips.cc> 최적화시 다시 고려!
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/aec/aec_core_neon.cc> 최적화시 다시 고려!

#define MulRe MulRe_aec_core_sse2_BOSS
#define MulIm MulIm_aec_core_sse2_BOSS
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/aec/aec_core_sse2.cc>
#undef MulRe
#undef MulIm

#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/aec/aec_resampler.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/aec/echo_cancellation.cc>
...
extern "C"
{
    #include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/agc/legacy/analog_agc.c>
    #include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/agc/legacy/digital_agc.c>
}
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/agc2/adaptive_mode_level_estimator_agc.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/agc2/agc2_testing_common.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/agc2/fixed_gain_controller.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/agc2/gain_applier.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/agc2/gain_curve_applier.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/agc2/rnn_vad/fft_util.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/audio_generator/file_audio_generator.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/include/audio_generator_factory.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/intelligibility/intelligibility_enhancer.cc>
#undef kChunkSizeMs

#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/intelligibility/intelligibility_utils.cc>

#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/logging/apm_data_dumper.cc>

extern "C"
{
    #include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/ns/noise_suppression.c>
    #include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/ns/noise_suppression_x.c>

    #define NoiseEstimation NoiseEstimation_ns_core_BOSS
    #define UpdateNoiseEstimate UpdateNoiseEstimate_ns_core_BOSS
    #include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/ns/ns_core.c>
    #undef NoiseEstimation
    #undef UpdateNoiseEstimate

    #define UpdateNoiseEstimate UpdateNoiseEstimate_nsx_core_BOSS
    #include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/ns/nsx_core.c>
    #undef UpdateNoiseEstimate

    #include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/ns/nsx_core_c.c>
    //#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/ns/nsx_core_mips.c> 최적화시 다시 고려!
    //#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/ns/nsx_core_neon.c> 최적화시 다시 고려!
}
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/transient/transient_suppressor.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/utility/block_mean_calculator.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/utility/ooura_fft.cc>
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/utility/ooura_fft_mips.cc> 최적화시 다시 고려!
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/utility/ooura_fft_neon.cc> 최적화시 다시 고려!
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/audio_processing/utility/ooura_fft_sse2.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/bitrate_controller/bitrate_controller.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/bitrate_controller/bitrate_controller_impl.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/bitrate_controller/send_side_bandwidth_estimation.cc>

#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/congestion_controller/congestion_window_pushback_controller.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/congestion_controller/send_side_congestion_controller.cc>
#undef kRetransmitWindowSizeMs
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/congestion_controller/transport_feedback_adapter.cc>

#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/congestion_controller/bbr/bandwidth_sampler.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/congestion_controller/bbr/bbr_factory.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/congestion_controller/bbr/bbr_network_controller.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/congestion_controller/bbr/data_transfer_tracker.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/congestion_controller/bbr/loss_rate_filter.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/congestion_controller/bbr/rtt_stats.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/congestion_controller/goog_cc/goog_cc_factory.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/congestion_controller/goog_cc/median_slope_estimator.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/congestion_controller/rtp/pacer_controller.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/congestion_controller/rtp/send_side_congestion_controller.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/congestion_controller/rtp/send_time_history.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/pacing/packet_queue.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/pacing/packet_queue_interface.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/remote_bitrate_estimator/test/bwe_test_framework.cc>

#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/rtp_rtcp/include/rtp_rtcp_defines.cc>

#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/rtp_rtcp/source/contributing_sources.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/rtp_rtcp/source/playout_delay_oracle.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/rtp_rtcp/source/rtp_header_parser.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/rtp_rtcp/source/rtp_payload_registry.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/rtp_rtcp/source/rtp_receiver_audio.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/rtp_rtcp/source/rtp_receiver_impl.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/rtp_rtcp/source/rtp_receiver_strategy.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/rtp_rtcp/source/rtp_receiver_video.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/rtp_rtcp/source/rtcp_packet/voip_metric.cc>
...
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/utility/source/helpers_android.cc>
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/utility/source/jvm_android.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/video_coding/encoder_database.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/video_coding/generic_encoder.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/video_coding/media_optimization.cc>

#define kDefaultRttMs kDefaultRttMs_nack_module_BOSS
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/video_coding/nack_module.cc>
#undef kDefaultRttMs
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/video_coding/qp_parser.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/video_coding/video_sender.cc>
...
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/video_coding/codecs/vp8/libvpx_vp8_decoder.cc> libyuv필요!
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/video_coding/codecs/vp8/libvpx_vp8_encoder.cc> libyuv필요!
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/video_coding/codecs/vp8/screenshare_layers.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/video_coding/codecs/vp8/temporal_layers.cc>

#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/video_coding/codecs/vp9/svc_config.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/video_coding/codecs/vp9/svc_rate_allocator.cc>
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/video_coding/codecs/vp9/vp9_frame_buffer_pool.cc> vpx필요!
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/video_coding/codecs/vp9/vp9_impl.cc> vpx필요!
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/video_coding/codecs/vp9/vp9_noop.cc>

#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/video_coding/utility/default_video_bitrate_allocator.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/video_coding/utility/moving_average.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/logging/rtc_event_log/icelogger.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/logging/rtc_event_log/rtc_event_log.cc>
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/logging/rtc_event_log/rtc_event_log2rtp_dump.cc>
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/logging/rtc_event_log/rtc_event_log2stats.cc>
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/logging/rtc_event_log/rtc_event_log2text.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/logging/rtc_event_log/rtc_event_log_factory.cc>
...
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/logging/rtc_event_log/rtc_event_log_parser_new.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/logging/rtc_event_log/output/rtc_event_log_output_file.cc>
...
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/system_wrappers/source/cpu_features_android.c>
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/system_wrappers/source/cpu_features_linux.c>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/system_wrappers/source/cpu_info.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/system_wrappers/source/event.cc>
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/system_wrappers/source/event_timer_posix.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/system_wrappers/source/event_timer_win.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/system_wrappers/source/field_trial_default.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/system_wrappers/source/metrics_default.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/system_wrappers/source/rtp_to_ntp_estimator.cc>
#include <addon/webrtc-jumpingyang001-20210616_for_boss/system_wrappers/source/runtime_enabled_features_default.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/video/overuse_frame_detector.cc>
...
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/video/replay.cc>
...
#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/video_capture/windows/device_info_mf.cc>
...
//#include <addon/webrtc-jumpingyang001-20210616_for_boss/modules/video_capture/windows/video_capture_mf.cc>
