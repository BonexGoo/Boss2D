...
#include BOSS_OPENSSL_V_openssl__dsa_h //original-code:<openssl/dsa.h>         /* For d2i_DSAPrivateKey */
...
#include BOSS_OPENSSL_V_openssl__pkcs12_h //original-code:<openssl/pkcs12.h>      /* For the PKCS8 stuff o.O */
#include BOSS_OPENSSL_V_openssl__rsa_h //original-code:<openssl/rsa.h>         /* For d2i_RSAPrivateKey */
#include BOSS_OPENSSL_V_openssl__safestack_h //original-code:<openssl/safestack.h>
#include BOSS_OPENSSL_V_openssl__store_h //original-code:<openssl/store.h>
#include BOSS_OPENSSL_V_openssl__ui_h //original-code:<openssl/ui.h>
#include BOSS_OPENSSL_V_openssl__x509_h //original-code:<openssl/x509.h>        /* For the PKCS8 stuff o.O */
#include BOSS_OPENSSL_U_internal__asn1_int_h //original-code:"internal/asn1_int.h"
#include BOSS_OPENSSL_U_internal__ctype_h //original-code:"internal/ctype.h"
#include BOSS_OPENSSL_U_internal__o_dir_h //original-code:"internal/o_dir.h"
#include BOSS_OPENSSL_U_internal__cryptlib_h //original-code:"internal/cryptlib.h"
#include BOSS_OPENSSL_U_internal__store_int_h //original-code:"internal/store_int.h"
