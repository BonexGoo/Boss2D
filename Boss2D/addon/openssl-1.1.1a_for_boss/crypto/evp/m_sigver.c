...
// removed by BOSS: static int update(EVP_MD_CTX *ctx, const void *data, size_t datalen)
static int update_m_sigver_BOSS(EVP_MD_CTX *ctx, const void *data, size_t datalen) // added by BOSS
{
                          ...
                          int ver)
{
    ...
    if (ver) {
        if (ctx->pctx->pmeth->verifyctx_init) {
            ...
            // removed by BOSS: ctx->update = update;
            ctx->update = update_m_sigver_BOSS; // added by BOSS
