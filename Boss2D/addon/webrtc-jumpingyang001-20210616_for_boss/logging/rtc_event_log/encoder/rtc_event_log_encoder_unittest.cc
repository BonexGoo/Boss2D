...
#include BOSS_WEBRTC_U_logging__rtc_event_log__encoder__rtc_event_log_encoder_legacy_h //original-code:"logging/rtc_event_log/encoder/rtc_event_log_encoder_legacy.h"
