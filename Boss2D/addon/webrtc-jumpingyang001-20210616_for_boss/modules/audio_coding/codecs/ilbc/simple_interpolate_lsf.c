...
#include BOSS_WEBRTC_U_modules__audio_coding__codecs__ilbc__lsf_interpolate_to_poly_enc_h //original-code:"modules/audio_coding/codecs/ilbc/lsf_interpolate_to_poly_enc.h"
