...
#include BOSS_WEBRTC_U_modules__audio_coding__codecs__opus__audio_encoder_multi_channel_opus_impl_h //original-code:"modules/audio_coding/codecs/opus/audio_encoder_multi_channel_opus_impl.h"
