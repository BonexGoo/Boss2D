...
int16_t WebRtcIsacfix_Create(ISACFIX_MainStruct **ISAC_main_inst)
{
  ...
  tempo = (ISACFIX_SubStruct*) malloc(1 * sizeof(ISACFIX_SubStruct)); //added by BOSS:(ISACFIX_SubStruct*)
...
int16_t WebRtcIsacfix_CreateInternal(ISACFIX_MainStruct *ISAC_main_inst)
{
  ...
  ISAC_inst->ISACenc_obj.SaveEnc_ptr = (IsacSaveEncoderData*) malloc(1 * sizeof(IsacSaveEncoderData)); //added by BOSS:(IsacSaveEncoderData*)
