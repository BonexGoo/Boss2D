...
#include BOSS_WEBRTC_U_modules__video_processing__util__denoiser_filter_h //original-code:"modules/video_processing/util/denoiser_filter.h"

#include BOSS_WEBRTC_U_modules__video_processing__util__denoiser_filter_c_h //original-code:"modules/video_processing/util/denoiser_filter_c.h"
...
#include BOSS_WEBRTC_U_modules__video_processing__util__denoiser_filter_sse2_h //original-code:"modules/video_processing/util/denoiser_filter_sse2.h"
#elif defined(WEBRTC_HAS_NEON)
#include BOSS_WEBRTC_U_modules__video_processing__util__denoiser_filter_neon_h //original-code:"modules/video_processing/util/denoiser_filter_neon.h"
#endif
