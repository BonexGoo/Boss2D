...
#include BOSS_WEBRTC_U_modules__desktop_capture__win__cursor_unittest_resources_h //original-code:"modules/desktop_capture/win/cursor_unittest_resources.h"
