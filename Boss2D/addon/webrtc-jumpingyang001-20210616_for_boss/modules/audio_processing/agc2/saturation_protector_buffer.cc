...
#include BOSS_WEBRTC_U_modules__audio_processing__agc2__saturation_protector_buffer_h //original-code:"modules/audio_processing/agc2/saturation_protector_buffer.h"
