...
#include BOSS_WEBRTC_U_rtc_base__ifaddrs_converter_h //original-code:"rtc_base/ifaddrs_converter.h"
#endif
...
#include BOSS_WEBRTC_U_rtc_base__socket_h //original-code:"rtc_base/socket.h"  // includes something that makes windows happy
