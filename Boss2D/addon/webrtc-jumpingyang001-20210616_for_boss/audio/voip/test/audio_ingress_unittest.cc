...
#include BOSS_WEBRTC_U_audio__voip__audio_ingress_h //original-code:"audio/voip/audio_ingress.h"
...
#include BOSS_WEBRTC_U_audio__voip__audio_egress_h //original-code:"audio/voip/audio_egress.h"
