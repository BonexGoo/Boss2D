...
#include BOSS_WEBRTC_U_media__sctp__usrsctp_transport_h //original-code:"media/sctp/usrsctp_transport.h"
#include BOSS_WEBRTC_U_p2p__base__dtls_transport_internal_h //original-code:"p2p/base/dtls_transport_internal.h"  // For PF_NORMAL
