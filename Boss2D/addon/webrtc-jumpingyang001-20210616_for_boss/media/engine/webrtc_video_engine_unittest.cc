...
#include BOSS_WEBRTC_U_media__base__fake_network_interface_h //original-code:"media/base/fake_network_interface.h"
...
#include BOSS_WEBRTC_U_media__engine__fake_webrtc_video_engine_h //original-code:"media/engine/fake_webrtc_video_engine.h"
