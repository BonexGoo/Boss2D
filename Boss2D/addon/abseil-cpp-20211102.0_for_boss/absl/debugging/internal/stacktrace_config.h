...
//removed by BOSS:#error ABSL_STACKTRACE_INL_HEADER cannot be directly set

#elif defined(_WIN32)
//removed by BOSS:#define ABSL_STACKTRACE_INL_HEADER \
//removed by BOSS:    "absl/debugging/internal/stacktrace_win32-inl.inc"
