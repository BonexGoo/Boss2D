...
#include BOSS_ABSEILCPP_U_absl__base__internal__scoped_set_env_h //original-code:"absl/base/internal/scoped_set_env.h"
#include BOSS_ABSEILCPP_U_absl__flags__declare_h //original-code:"absl/flags/declare.h"
