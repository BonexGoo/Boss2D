...
const char CZipArchive::m_gszCopyright[] = {"The ZipArchive Library Copyright (c) 2000 - 2019 Artpol Software - Tadeusz Dracz"};
const char CZipArchive::m_gszVersion[] = {"4.6.7"};
