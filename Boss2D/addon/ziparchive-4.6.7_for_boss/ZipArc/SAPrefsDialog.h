...
// Dialog Data
   ...
   // add a page (page, page title string resource, optional parent)
   bool AddPage(CSAPrefsSubDlg &page, UINT nID, CSAPrefsSubDlg *pDlgParent = NULL)
   {
	   return AddPage(page, CString((LPCTSTR)nID), pDlgParent);
   }
   ...
   void EndSpecial(UINT res, bool bOk = true);
	...
	// set the first page
	void SetStartPage(int iPage) {m_iStartPage = iPage;}
...
protected:
   ...
   CMap< CSAPrefsSubDlg *, CSAPrefsSubDlg *, HTREEITEM, HTREEITEM&  > m_dlgMap;
