...
INT_PTR CSortableObArray::InsertSorted(CObject *newElement)
{
	if (!m_pSortFunction)	
	{
...
void CSortableObArray::Sort()
{
	...
	INT_PTR iElements = GetSize();
	INT_PTR iInner,iOuter,iStride = 1;
	CObject *pTmp;
...
void CSortableObArray::RemoveAt(INT_PTR nIndex, INT_PTR nCount)
{
