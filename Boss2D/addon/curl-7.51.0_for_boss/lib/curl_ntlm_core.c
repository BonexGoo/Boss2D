...
#  include <pk11pub.h>
#  include <hasht.h>
#  include BOSS_CURL_U_curl_md4_h //original-code:"curl_md4.h"
...
#  include BOSS_FAKEWIN_V_wincrypt_h //original-code:<wincrypt.h>
#else
