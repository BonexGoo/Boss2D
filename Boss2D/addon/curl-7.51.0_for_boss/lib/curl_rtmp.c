...
#include BOSS_CURL_U_nonblock_h //original-code:"nonblock.h" /* for curlx_nonblock */
#include BOSS_CURL_U_progress_h //original-code:"progress.h" /* for Curl_pgrsSetUploadSize */
...
#include BOSS_RTMPDUMP_V_librtmp__rtmp_h //original-code:<librtmp/rtmp.h>
...
#ifdef _WIN32
// removed by BOSS: #define setsockopt(a,b,c,d,e) (setsockopt)(a,b,c,(const char *)d,(int)e)
