...
#include BOSS_CURL_U_connect_h //original-code:"connect.h" /* for the connect timeout */
#include BOSS_CURL_U_strerror_h //original-code:"strerror.h"
#include BOSS_CURL_U_select_h //original-code:"select.h" /* for the socket readyness */
#include BOSS_CURL_U_inet_pton_h //original-code:"inet_pton.h" /* for IP addr SNI check */
