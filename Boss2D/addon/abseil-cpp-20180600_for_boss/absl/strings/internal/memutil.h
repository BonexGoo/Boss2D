...
#include BOSS_ABSEILCPP_U_absl__base__port_h //original-code:"absl/base/port.h"  // disable some warnings on Windows
#include BOSS_ABSEILCPP_U_absl__strings__ascii_h //original-code:"absl/strings/ascii.h"  // for absl::ascii_tolower
