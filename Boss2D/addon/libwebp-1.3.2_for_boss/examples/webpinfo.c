...
#include BOSS_WEBP_U_webp__format_constants_h //original-code:"webp/format_constants.h"
#include BOSS_WEBP_U_webp__mux_types_h //original-code:"webp/mux_types.h"
