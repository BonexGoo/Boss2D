...
#include BOSS_WEBP_U_src__enc__cost_enc_h //original-code:"src/enc/cost_enc.h"
...
#include BOSS_WEBP_U_src__webp__format_constants_h //original-code:"src/webp/format_constants.h"  // RIFF constants
