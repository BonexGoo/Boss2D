...
#include BOSS_LIBYUV_U_libyuv__convert_h //original-code:"libyuv/convert.h"  // For I420Copy
...
#include BOSS_LIBYUV_U_libyuv__scale_h //original-code:"libyuv/scale.h"  // For ScalePlane()
