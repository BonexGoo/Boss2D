...
#include "../../bodymovin/bmimagelayer_p.h"
...
// QTCREATOR가 아닌 경우 MOC코드 포함
    ...
    #if BOSS_NDEBUG
        #if BOSS_X64
            #include "../../../../../../project/GeneratedFiles/Release64/moc_batchrenderer.cpp"
        #else
            #include "../../../../../../project/GeneratedFiles/Release32/moc_batchrenderer.cpp"
        #endif
    #else
        #if BOSS_X64
            #include "../../../../../../project/GeneratedFiles/Debug64/moc_batchrenderer.cpp"
        #else
            #include "../../../../../../project/GeneratedFiles/Debug32/moc_batchrenderer.cpp"
        #endif
    #endif
#endif
