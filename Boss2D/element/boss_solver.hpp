...
namespace BOSS
{
    ...
    class SolverValue
    {
        ...
        public: SolverValue BitXor(const SolverValue& rhs) const;
        public: SolverValue BitShiftL(const SolverValue& rhs) const;
        public: SolverValue BitShiftR(const SolverValue& rhs) const;
    ...
    class Solver
    {
        ...
        public: static void RemoveMatchedVariables(chars chain, chars keyword, SolverVariableCB cb = nullptr, bool match_from_start = false);
