...
#include "../bodymovin/bmbase_p.h"
#include "../bodymovin/bmlayer_p.h"

#include "rasterrenderer/batchrenderer.h"
#include "rasterrenderer/lottierasterrenderer.h"

//removed by BOSS: Q_LOGGING_CATEGORY(lcLottieQtBodymovinRender, "qt.lottieqt.bodymovin.render");
//removed by BOSS: Q_LOGGING_CATEGORY(lcLottieQtBodymovinParser, "qt.lottieqt.bodymovin.parser");
...
LottieAnimation::LottieAnimation(fake_QQuickItem *parent)
    : fake_QQuickPaintedItem(parent)
{
...
{
    fake_QQuickPaintedItem::componentComplete();
...
void LottieAnimation::setQuality(LottieAnimation::Quality quality)
{
    if (m_quality != quality) {
        ...
        if (quality == LowQuality)
            setRenderTarget(fake_QQuickPaintedItem::FramebufferObject);
        else
            setRenderTarget(fake_QQuickPaintedItem::Image);
...
void LottieAnimation::load()
{
    ...
    m_file.reset(new fake_QQmlFile(m_source));
    if (m_file->isLoading())
...
// QTCREATOR가 아닌 경우 MOC코드 포함
    ...
    #if BOSS_NDEBUG
        #if BOSS_X64
            #include "../../../../../project/GeneratedFiles/Release64/moc_lottieanimation.cpp"
        #else
            #include "../../../../../project/GeneratedFiles/Release32/moc_lottieanimation.cpp"
        #endif
    #else
        #if BOSS_X64
            #include "../../../../../project/GeneratedFiles/Debug64/moc_lottieanimation.cpp"
        #else
            #include "../../../../../project/GeneratedFiles/Debug32/moc_lottieanimation.cpp"
        #endif
    #endif
#endif
