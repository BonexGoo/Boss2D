...
public:
    ...
    public:
        ...
        /// @brief 지정한 서피스 또는 스크린으로 텍스처 출력
        /// @param surface_or_screen : 입력받을 서피스 또는 스크린(nullptr일때)
        /// @param x : 서피스 또는 스크린의 좌측위치(px)
        /// @param y : 서피스 또는 스크린의 상단위치(px)
        /// @param w : 서피스 또는 스크린의 가로길이(px)
        /// @param h : 서피스 또는 스크린의 세로길이(px)
        ...
        /// @param color : 컬러링값
        static void DrawTexture(id_surface surface_or_screen, float x, float y, float w, float h,
            id_texture_read texture, float tx, float ty, float tw, float th, orientationtype ori, bool antialiasing, Color color = Color::White);
        ...
        /// @brief 지정한 서피스 또는 스크린으로 폴리곤영역식 이미지 출력
        /// @param surface_or_screen : 입력받을 서피스 또는 스크린(nullptr일때)
        /// @param x : 서피스 또는 스크린의 좌측위치(px)
        /// @param y : 서피스 또는 스크린의 상단위치(px)
        /// @param ps : 꼭지점들(px)
        /// @param image : 출력할 이미지
        /// @param ips : 이미지의 꼭지점들(uv값, x는 0~1, y는 0~1)
        /// @param color : 컬러링값
        static void DrawPolyImage(id_surface surface_or_screen, float x, float y, const Point (&ps)[3],
        ...
        static void DrawSurface(float x, float y, float w, float h, id_surface_read surface, float sx, float sy, float sw, float sh);

        /// @brief 지정한 서피스로 서피스 출력
        /// @param dest : 입력받을 서피스
        /// @param dx : 서피스의 좌측위치(px)
        /// @param dy : 서피스의 상단위치(px)
        /// @param dw : 서피스의 가로길이(px)
        /// @param dh : 서피스의 세로길이(px)
        /// @param src : 출력할 서피스
        /// @param sx : 서피스의 좌측위치(px)
        /// @param sy : 서피스의 상단위치(px)
        /// @param sw : 서피스의 가로길이(px)
        ...
        /// @param antialiasing : 계단현상 보간처리 적용여부
        /// @param color : 컬러링값
        static void DrawSurfaceToSurface(id_surface dest, float dx, float dy, float dw, float dh,
            id_surface_read src, float sx, float sy, float sw, float sh, orientationtype ori, bool antialiasing, Color color = Color::White);
